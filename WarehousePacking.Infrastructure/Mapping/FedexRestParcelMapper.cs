...
namespace WarehousePacking.API.Integrations.Couriers.Mapping
{
    public class FedexRestParcelMapper : IParcelMapper<FedexShipmentRequest>
    {
        ...
        private List<Contracts.DTOs.Couriers.Fedex.Recipient> MapRecipents(PackageData package)
        {
            List<Contracts.DTOs.Couriers.Fedex.Recipient> recipents = new()
            {
                new Contracts.DTOs.Couriers.Fedex.Recipient
                {
                    Address = new Address
                    {
