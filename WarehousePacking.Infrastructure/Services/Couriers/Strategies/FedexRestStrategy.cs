...
{
    public class FedexRestStrategy : ICourierService
    {
        ...
        public FedexRestStrategy(HttpClient httpClient, IParcelMapper<FedexShipmentRequest> mapper, IOptions<CourierSettings> settings)
        {
            _httpClient = httpClient;
            _mapper = mapper;
            _settings = settings.Value.Fedex.Rest;
        }
        ...
        Task<CourierProtocolResponse> ICourierService.GenerateProtocol(IEnumerable<RoutePackages> shipments)
        {
            throw new NotImplementedException();
        }
